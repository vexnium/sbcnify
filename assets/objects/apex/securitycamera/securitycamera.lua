...
function scanState.update(dt, stateData)
  ...
  if stateData.timer < 0 or stateData.timer > rotationTime then
    ...
    object.setAnimationState("movement", "move")
  end
...
function alertState.enterWith(targetId)
  object.rotateGroup("camera", object.currentRotationAngle("camera"))
  object.setAnimationState("movement", "alert")
